...
<h3>NERACA SALDO   
<? 
$_POST['tgl1']=$_GET['tgl1'];
echo $_POST['tgl1']; 
$_SESSION['nrctgl']=$_POST['tgl1']; 
?>
</h3>
<style>
table.stat {
...
<tr><th>No</th><th>KETERANGAN</th><th>Rekening</th><th width=150>Total Debet</th><th width=150>Total Kedit</th><th width=150>SALDO</th><th width=150>ANGGARAN</th></tr>
...
<?
$rcek = mysqli_query($con,"SELECT * FROM anggaran where rekening='".$row[0]."' and kelompok='".$_SESSION['user']."'");
$rcekj=mysqli_fetch_array($rcek);
$anggaran=$rcekj['anggaran']; 
?>
<td align='right'><? echo number_format($anggaran,0,',','.');?></td>
</tr>
