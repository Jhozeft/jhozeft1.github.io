<html>
<head>
<title>Setor uang ke Bank</title>
...
?>
<h3>Transaksi Keluar <? echo strtoupper($_GET['id']); ?> : Setor Uang Ke BANK </h3>
<hr>
<table>
...
<td></td><td>
 ...
 <input type=hidden name=debet value=<? echo $banko; ?> > 
 <input type=hidden name=kredit value=<? echo $kdkas; ?> > 
