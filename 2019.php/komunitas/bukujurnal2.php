...
$result = mysqli_query($con,"SELECT * FROM kas2");

$tdeb=0;
$tkre=0;
echo "<table  class='stat' width=95%>";
echo "<td>No</td><td>REKENING</td><td>DEBET/KREDIT</td><td>Keterangan</td><td>Rp. DEBET</td><td>Rp. KREDIT</td>";
