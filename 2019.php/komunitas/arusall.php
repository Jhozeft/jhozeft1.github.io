...
$result = mysqli_query($con,"SELECT * FROM kas where unit not like '%DEL%' and rekening='".$_GET['rek']."' order by Tanggal, id asc");
...
$id=$row['notag'];
  ...
  echo "<td align='left'>".$row[5]."/".$row['unit']. "</td>";
